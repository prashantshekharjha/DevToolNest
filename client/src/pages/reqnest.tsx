                      ...
                      <div className="bg-gradient-to-br from-peach-50 via-orange-50 to-yellow-50 dark:from-orange-900/10 dark:via-yellow-900/10 dark:to-peach-900/10 rounded-2xl border border-orange-200 dark:border-orange-700 shadow-md">
                        ...
                        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                          <TabsList className="flex w-full gap-2 bg-orange-50 dark:bg-orange-900/10 rounded-full p-1 shadow-sm">
                            <TabsTrigger value="params" className="rounded-full px-5 py-2 font-semibold text-purple-900 dark:text-purple-200 data-[state=active]:bg-gradient-to-r data-[state=active]:from-orange-200 data-[state=active]:to-yellow-100 data-[state=active]:shadow-md data-[state=active]:text-purple-900 transition-all">Parameters</TabsTrigger>
                            <TabsTrigger value="headers" className="rounded-full px-5 py-2 font-semibold text-purple-900 dark:text-purple-200 data-[state=active]:bg-gradient-to-r data-[state=active]:from-orange-200 data-[state=active]:to-yellow-100 data-[state=active]:shadow-md data-[state=active]:text-purple-900 transition-all">Headers</TabsTrigger>
                            <TabsTrigger value="body" className="rounded-full px-5 py-2 font-semibold text-purple-900 dark:text-purple-200 data-[state=active]:bg-gradient-to-r data-[state=active]:from-orange-200 data-[state=active]:to-yellow-100 data-[state=active]:shadow-md data-[state=active]:text-purple-900 transition-all">Body</TabsTrigger>
                            <TabsTrigger value="auth" className="rounded-full px-5 py-2 font-semibold text-purple-900 dark:text-purple-200 data-[state=active]:bg-gradient-to-r data-[state=active]:from-orange-200 data-[state=active]:to-yellow-100 data-[state=active]:shadow-md data-[state=active]:text-purple-900 transition-all">Auth</TabsTrigger>
                            <TabsTrigger value="scripts" className="rounded-full px-5 py-2 font-semibold text-purple-900 dark:text-purple-200 data-[state=active]:bg-gradient-to-r data-[state=active]:from-orange-200 data-[state=active]:to-yellow-100 data-[state=active]:shadow-md data-[state=active]:text-purple-900 transition-all flex items-center"><Code className="inline w-4 h-4 mr-1" /> Scripts</TabsTrigger>
                          </TabsList>
